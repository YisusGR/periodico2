...
<nav>
    ...
    <div class="wrapper">
        ...
        <div class="enlace">
        <div class="enlace1">
        <a href="noticias/deportes.php">Deportes</a>
        </div>
        <div class="enlace1">
        <a href="noticias/politica.php">Politica</a></div>
        <div class="enlace1">
        <a href="noticias/rojas.php">Rojas</a></div>
        <div class="enlace1">
        <a href="noticias/nacionales.php">Nacionales</a></div>
        </div>
        </div>
    </div>
